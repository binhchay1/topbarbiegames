<?php
class Widget_MyArcadeTheme_Box_Fullwidth extends WP_Widget {

  // Constructor
  function __construct() {
    parent::__construct(
      'Widget_MyArcadeTheme_Box_Fullwidth',
      __( 'Front Page - Full Width Box', 'myarcadetheme' ),
      array(
        'description' =>  __( "Display games in a full width box.", 'myarcadetheme' )
      )
    );
  }
 ...
 * @return  void
 */
function myarcadetheme_widget_box_fullwidth() {
  register_widget('Widget_MyArcadeTheme_Box_Fullwidth');
}
add_action( 'widgets_init', 'myarcadetheme_widget_box_fullwidth' );