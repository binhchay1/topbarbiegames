<?php
class Widget_MyArcadeTheme_Box_Vertical extends WP_Widget {

  // Constructor
  function __construct() {
    parent::__construct(
      'Widget_MyArcadeTheme_Box_Vertical',
      __( 'Front Page - Vertical Box', 'myarcadetheme' ),
      array(
        'description' =>  __( "Display games in a vertical box.", 'myarcadetheme' )
      )
    );
  }
 ...
 /**
  ...
  function form( $instance ) {
    ...
    $instance = wp_parse_args( (array) $instance, array(
      ...
      'order2'     => 'DESC',
      'category2'  => 0,
      'title3'     => __("Box name", 'myarcadetheme'),
      'limit3'     => 3,
      'orderby3'   => 'date',
      'order3'     => 'DESC',
      'category3'  => 0,
 ...
 * @return  void
 */
function myarcadetheme_widget_box_vertical() {
  register_widget('Widget_MyArcadeTheme_Box_Vertical');
}
add_action( 'widgets_init', 'myarcadetheme_widget_box_vertical' );