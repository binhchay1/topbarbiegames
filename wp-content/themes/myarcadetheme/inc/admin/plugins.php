...
add_action( 'tgmpa_register', 'myarcadetheme_register_required_plugins' );

function myarcadetheme_register_required_plugins() {
    ...
    $plugins = array(
      ...
      array(
        'name'               => 'MyGameListCreator (Install it manually)',
      ...
      array(
        'name'               => 'MyScoresPresenter (Install it manually)',
     ...
     */
    $config = array(
        'id'           => 'myarcadetheme',         // Unique ID for hashing notices for multiple instances of TGMPA.
        'default_path' => '',                      // Default absolute path to pre-packaged plugins.
        'menu'         => 'myarcadetheme-install-plugins', // Menu slug.
